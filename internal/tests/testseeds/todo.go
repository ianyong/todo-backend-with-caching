...
var todos = []domainmodels.Todo{
	{
		...
		DueDate:     time.Date(2021, time.November, 1, 0, 0, 0, 0, time.UTC),
		IsCompleted: false,
	},
	{
		ID:          2,
		...
		DueDate:     time.Date(2021, time.November, 2, 0, 0, 0, 0, time.UTC),
		IsCompleted: true,
	},
	{
		ID:          3,
		...
		DueDate:     time.Date(2021, time.November, 3, 0, 0, 0, 0, time.UTC),
		IsCompleted: false,
	},
	{
		ID:          4,
		...
		DueDate:     time.Date(2021, time.November, 4, 0, 0, 0, 0, time.UTC),
		IsCompleted: false,
	},
	{
		ID:          5,
		...
		DueDate:     time.Date(2021, time.November, 5, 0, 0, 0, 0, time.UTC),
		IsCompleted: false,
	},
	{
		ID:          6,
		...
		DueDate:     time.Date(2021, time.November, 6, 0, 0, 0, 0, time.UTC),
		IsCompleted: false,
	},
	{
		ID:          7,
		...
		DueDate:     time.Date(2021, time.November, 7, 0, 0, 0, 0, time.UTC),
		IsCompleted: false,
	},
}
